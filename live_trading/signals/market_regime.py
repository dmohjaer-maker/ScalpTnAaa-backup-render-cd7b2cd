...
REGIME_RULES = {
    "STRONG_TREND_BULL": RegimeEntryRules(48, 1.2, True,  False, 1.0,  "Strong Bull Trend"),
    "STRONG_TREND_BEAR": RegimeEntryRules(48, 1.2, False, True,  1.0,  "Strong Bear Trend"),
    "WEAK_TREND_BULL":   RegimeEntryRules(48, 1.2, True,  False, 0.9,  "Weak Bull Trend"),
    "WEAK_TREND_BEAR":   RegimeEntryRules(48, 1.2, False, True,  0.9,  "Weak Bear Trend"),
    "PULLBACK_BULL":     RegimeEntryRules(48, 1.2, True,  False, 0.95, "Bull Pullback"),
    "PULLBACK_BEAR":     RegimeEntryRules(48, 1.2, False, True,  0.95, "Bear Pullback"),
    "RANGE":             RegimeEntryRules(50, 1.2, True,  True,  0.8,  "Range / Choppy"),
    "ACCUMULATION":      RegimeEntryRules(48, 1.0, True,  False, 1.0,  "Wyckoff Accumulation"),
    "DISTRIBUTION":      RegimeEntryRules(48, 1.0, False, True,  1.0,  "Wyckoff Distribution"),
    "HIGH_VOLATILITY":   RegimeEntryRules(52, 1.2, True,  True,  1.3,  "High Volatility"),
    "LOW_VOLATILITY":    RegimeEntryRules(50, 1.2, True,  True,  0.7,  "Low Volatility / Squeeze"),
}
